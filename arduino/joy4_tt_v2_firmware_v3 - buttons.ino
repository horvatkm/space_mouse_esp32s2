...
int minVals[8]={-190,-504,-195,-520,-100,-409,-508,-506};
int maxVals[8]={521,518,155,403,205,512,514,516};
...
// Indipendent sensitivity multiplier for each axis movement. Use degbug mode 3 or use for example your cad program to verify changes.
/* Factory Settings:
...
int DEADZONE = 1; // Recommended to have this as small as possible for V2 to allow smaller knob range of motion.
